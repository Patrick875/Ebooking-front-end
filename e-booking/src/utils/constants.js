...
export const initialRowsDelivery = [
  {
    id: uuidv4(),
    description: '',
    unitPrice: 0,
...
export const initialRowsEvents = [
  {
    id: uuidv4(),
    name: '',
    quantity: 0,
...
export const caterings = [
  { name: ' Outside Catering 1' },
  { name: ' Outside Catering 2' },
  { name: ' Outside Catering 3' },
  { name: ' Outside Catering 4' },
]
